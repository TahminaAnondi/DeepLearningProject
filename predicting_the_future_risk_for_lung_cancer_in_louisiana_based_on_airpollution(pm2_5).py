...
# Load the datasets
lung_cancer = pd.read_csv('/content/lung_cancer_data.csv')
pm25 = pd.read_csv('/content/pm25_data.csv')


# Load the shapefile
parishes_shapefile = gpd.read_file('/content/Louisiana_Parishes.shp')
